...
export type GetAllRecipesQuery = { __typename?: 'Query', recipes: Array<{ __typename?: 'RecipeModel', id: string, title: string, description: string, difficulty: Difficulty, cookingTime: number, likesCount: number, isLiked: boolean, calories: number, createdAt: any, tags?: Array<{ __typename?: 'RecipeTagModel', name: string }> | null }> };
